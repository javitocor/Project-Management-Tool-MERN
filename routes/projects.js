...
router.post('/create',  [upload.upload, validations.projectValidations], project_controller.project_create);
router.put('/:id',  [upload.upload, validations.projectValidations], project_controller.project_update);
